$(function () {
	...
	$("#fsenderAddress").on('click',function(){
		...
		window.sessionStorage.setItem('fAddress', JSON.stringify('fsenderAddress'));
	});
	...
	if(fsenderAddress.areaCode != '' && fsenderAddress.areaCode != null){
    ...
    function postDone() {
        ...
        var submitData = {
            ...
            fsenderCountyCode: isNull($("#fsenderCountyCode").val()),
            fsenderAddress: isNull($("#fsenderAddress").val()),
